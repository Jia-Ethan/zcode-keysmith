...
export function SettingsView() {
  ...
  const [dirInput, setDirInput] = React.useState(s.defaultManagedDir);
        ...
        <section className="card-glass mt-4 p-5" aria-label={t("settings.defaultDir")}>
          ...
          <div className="mt-1.5 flex gap-2">
            <Input
              ...
              onBlur={() => {
                saveSettings({ defaultManagedDir: dirInput.trim() });
                toast.success(t("settings.saved"));
              }}
            ...
            <Button
              ...
              onClick={async () => {
                ...
                if (picked) {
                  setDirInput(picked);
                  saveSettings({ defaultManagedDir: picked });
                  toast.success(t("settings.saved"));
                }
              }}
            >
