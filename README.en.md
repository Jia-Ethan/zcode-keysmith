...
Documented support is macOS with a local `ZCode.app`, and Windows 10/11 with a local `ZCode.exe`. No Release, no signed installer, no Desktop Beta. Python 3.10+ is recommended; Windows must retain the Python interpreter used during install.
